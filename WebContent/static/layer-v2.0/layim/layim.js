...
xxim.view = (function(){
    var xximNode = xxim.layimNode = $('<div id="xximmm" class="xxim_main">'
            ...
            +'<li class="xxim_online" id="xxim_online">'
                ...
                +'</div>'
            +'</li>'
            +'<li class="xxim_mymsg" id="xxim_mymsg" title="我的私信"><i class="fa fa-envelope"></i><a onclick=\'top.openTab("'+config.msgurl+'","信箱", false)\''+'></a></li>'
            +'<li class="xxim_mymsg" id="xxim_seter" title="我的通告"><i class="fa fa-bell"></i><a onclick=\'top.openTab("'+config.oaurl+'","通告", false)\'></a>'
            +'</li>'
