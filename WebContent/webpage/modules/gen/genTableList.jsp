...
<body class="gray-bg">
	...
	<div class="col-sm-12">
		<div class="pull-left">
				...
				<table:addRow url="${ctx}/gen/genTable/form" title="表单" width="1000px" height="550px"></table:addRow><!-- 增加按钮 -->
				</shiro:hasPermission>
			    ...
			    <table:editRow url="${ctx}/gen/genTable/form" title="表单" id="contentTable" width="1000px" height="550px"></table:editRow><!-- 编辑按钮 -->
			    </shiro:hasPermission>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="genTable">
			<tr>
				...
				<td><a  href="#" onclick="openDialogView('查看表单', '${ctx}/gen/genTable/form?id=${genTable.id}','1000px', '550px')">${genTable.name}</a></td>
				...
				<td>
					<shiro:hasPermission name="gen:genTable:edit">
					<a href="#" onclick="openDialog('修改业务表', '${ctx}/gen/genTable/form?id=${genTable.id}','1000px', '550px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 修改</a>
					</shiro:hasPermission>
