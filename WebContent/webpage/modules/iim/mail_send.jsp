...
<head>
    ...
    <script src="${ctxStatic}/ckfinder/ckfinder.js"></script>
            ...
            <div class="col-sm-9 animated fadeInRight">
                ...
                <div class="mail-box">
					...
					<form:form id="inputForm" modelAttribute="mailBox" action="${ctx}/iim/mailCompose/save" method="post" class="form-horizontal">
                        ...
                        <textarea name="mail.content" id="content" ></textarea>
                        <sys:ckeditor replace="content" height="500px" uploadPath="/gk"></sys:ckeditor>
 					</form:form>
                    </div>
...
//        };
        ...
        function sendLetter(){
            ...
            $("#overview").val(content.substring(0,20));
