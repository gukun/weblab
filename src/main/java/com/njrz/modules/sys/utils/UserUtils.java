 ...
 */
package com.njrz.modules.sys.utils;
...
import com.njrz.modules.sys.dao.*;
import com.njrz.modules.sys.entity.*;
...
import com.njrz.common.sms.SMSUtils;
import com.njrz.common.utils.CacheUtils;
import com.njrz.common.utils.SpringContextHolder;
import com.njrz.modules.sys.security.SystemAuthorizingRealm.Principal;
...
public class UserUtils {
    ...
    private static LessonDao lessonDao = SpringContextHolder.getBean(LessonDao.class);
    ...
    public static final String CACHE_LESSON_ALL_LIST = "lessonAllList";
        ...
        if (principal != null) {
            ...
            if (user != null) {
                if (user.getPhoto() == null || "".equals(user.getPhoto())) {
                    user.setPhoto("/weblab/static/common/login/img/default.jpg");
                }
                return user;
            }
            return new User();
    ...
    public static List<Lesson> getLessonList(){
        List<Lesson> lessonList = (List<Lesson>) getCache(CACHE_LESSON_ALL_LIST);
        if (lessonList == null) {

            User user = getUser();
            if (user.isAdmin()) {
                lessonList = lessonDao.findAllList(new Lesson());
            }
            putCache(CACHE_LESSON_ALL_LIST, lessonList);
        }
        return lessonList;
    }
